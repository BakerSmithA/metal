...
type AppResultConfig = AppResult Config
...
-- variable name.
shouldContainVar :: AppResultConfig -> VarName -> TapeSymbol -> Expectation
...
-- the function name.
shouldContainFunc :: AppResultConfig -> FuncName -> FuncDeclArgs -> Stm -> Expectation
